package com.ilci.config.custom;
...
public class CustomUserDetailSerice implements UserDetailsService {
    ...
    public CustomUserDetailSerice(UserRepository userRepository) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new CustomUserDetail(user.getUsername(), user.getPassword(),authorities(),user.getFullname());
    }
